...
public class SendHistoryActivity extends SwipeBackBaseActivity {
    ...
    public static void startActivity(Context context) {
        Intent intent = new Intent(context, SendHistoryActivity.class);
    ...
    private void getResultList() {
        ...
        resumeModel.getSendHistory(CoreApplication.appLoginMessage.userID)
