...
public class JobPtrHeader extends View implements PtrUIHandler {

    public interface PtrToolbarListener {
        void hideToolbar();

        void showToolbar();
    }

    private PtrToolbarListener toolbarHandler;
    ...
    private int mTextColor = Color.parseColor("#00695c");

    public JobPtrHeader(Context context, PtrToolbarListener toolbarHandler) {
        super(context);
        this.toolbarHandler = toolbarHandler;
        initView();
    }

    public JobPtrHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public JobPtrHeader(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public JobPtrHeader setLineWidth(int width) {
        mLineWidth = width;
    ...
    public JobPtrHeader setTextColor(int color) {
        mTextColor = color;
        for (int i = 0; i < mItemList.size(); i++) {
    ...
    public JobPtrHeader setDropHeight(int height) {
        mDropHeight = height;
        return this;
    }
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        LogUtil.debugLog("onUIRefreshPrepare");
        toolbarHandler.hideToolbar();
    }

    @Override
    public void onUIRefreshBegin(PtrFrameLayout frame) {
        LogUtil.debugLog("onUIRefreshBegin");
        beginLoading();
    }

    @Override
    public void onUIRefreshComplete(PtrFrameLayout frame) {
        LogUtil.debugLog("onUIRefreshComplete");
        toolbarHandler.showToolbar();
        loadFinish();
    }
